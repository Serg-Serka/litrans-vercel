  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center px-3 py-2 border rounded-md shadow-md header-button"
      >
        ...
        <div className="absolute mt-2 bg-white border rounded-md shadow-lg">
          {languages.map((lang) => (
            <button
              ...
              className="flex items-center w-full px-4 py-2 hover:bg-gray-100 lang-button"
            >
